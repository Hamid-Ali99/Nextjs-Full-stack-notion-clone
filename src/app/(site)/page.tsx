        ...
        >
          ...
          {[...Array(2)].map((arr, index) => (
            <div
              ...
              className={twMerge(
                clsx(
                  "mt-10 flex flex-nowrap gap-6 self-start pointer-events-none",
                  {
            ...
            <CustomCard
              ...
              "
                >
                  {card.planType === PRICING_PLANS.proplan && (
                    <>
                      <div className="hidden bg-brand-primaryPurple/80 absolute -z-10 top-0 dark:block w-full blur-[120px] rounded-full h-32 " />
                      <Image
                        src={Diamond}
                        alt="Pro Plan Icon"
              ...
              cardFooter={
                <ul className="flex flex-col font-normal mb-2 gap-4">
